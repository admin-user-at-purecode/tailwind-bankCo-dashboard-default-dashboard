    ...
    return (
        <main className="w-full px-6 pb-6 pt-[100px] sm:pt-[156px] xl:px-12 xl:pb-12">
            <div className="2xl:flex 2xl:space-x-[48px]">
                <section className="flex w-full flex-col space-x-0 lg:flex-row lg:space-x-6 2xl:w-[400px] 2xl:flex-col 2xl:space-x-0 mb-7">
                    <Wallet />
                    <TeamChat />
                </section>
                <section className="mb-6 2xl:mb-0 2xl:flex-1">
                    <TotalWidget />
                    <ListTab />
                    <div className="mb-[24px] w-full xl:flex xl:space-x-[24px] my-6">
                        <RevenueFlow />
                        <Efficiency />
                    </div>
                </section>
